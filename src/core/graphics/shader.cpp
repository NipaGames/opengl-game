...
void Shaders::LoadAllShaders() {
    ...
    LoadShaders(SHADER_UI_SHAPE, "../res/shaders/uishape.vert", "../res/shaders/uishape.frag");
    LoadShaders(SHADER_LINE, "../res/shaders/line.vert", "../res/shaders/line.frag", "../res/shaders/line.geom");
}
